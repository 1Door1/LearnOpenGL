...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Uniform", NULL, NULL);
    if (window == NULL)
    {
    ...
    //Shader ourShader("./Shaders/9.6.shader.vs",
    //    "./Shaders/9.6.shader.fs");

    //Shader shader("./Shaders/9.1.shader.vs",
    ...
    Shader shader("./Shaders/9.8.shader.vs", 
                  "./Shaders/9.8.shader.fs", 
                  "./Shaders/9.8.shader.gs");
